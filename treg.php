  ...
  <div class="row">
    ...
    <center><h2>..Register..</h2> <br><br>
      <form action="" method="POST">
        ...
        <div class="form-group">
          <input type="email" class="form-control" placeholder="Enter your email" name="em" id="em">
        </div>
        <div class="form-group">
       
            <input type="text" class="form-control" placeholder="Enter  department" name="dv" id="dv" >
          </div>
          <div class="form-group">
           
            <input type="text" class="form-control" placeholder="Enter section" name="sc" id="sc">
          </div>
          <div class="form-group">
...
if(isset($_POST['submit'])){
  ...
  $sc=$_POST['sc'];
  $gender=$_POST['gender'];
$sql1="insert into login(username,passwd,usertype,status) values('$uname','$pass','teacher',0)";
mysqli_query($con,$sql1);
  $result1=mysqli_query($con,"select * from login where username='$uname'");
 $row=mysqli_fetch_assoc($result1);
  
$sql2="insert into tregister(lid,name,email,department,section,gender) values('$row[lid]','$name','$em','$dv','$sc','$gender')";
