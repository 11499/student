...
$con = mysqli_connect('localhost','root','','student');
   ...
   $id=$_SESSION['sessid'] ;
  echo $id;
   $sql="select * from login join tregister on login.lid=tregister.lid where login.lid='$id'";
...
<td>  <input type="text" name="email" id="email" value="<?php echo $row['email'];?>"><br><br></td>
...
<tr>
  ...
  <td>  <input type="text" name="dv" id="dv" value="<?php echo $row['department'];?>"><br><br></td>

</tr>  
<tr>
        <td><label>section</label></td>
  <td>  <input type="text" name="sc" id="sc" value="<?php echo $row['section'];?>"><br><br></td>
...
$sql2="update tregister set name='$name',email='$email',department='$dv',section='$sc' where tid='$tid'";
//echo $sql2;
mysqli_query($con,$sql2);
$sql2="update login set uname='$uname',passwd='$passwd' where lid='$id'";
//echo $sql2;
mysqli_query($con,$sql2);
header('location:/student/teacherhome.php');
}
?>
</body>
</html>